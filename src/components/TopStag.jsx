...
function TopStag() {
  ...
  return (
    ...
    <div className='flex flex-row lg:mx-5 md:mx-5 sm:mx-5 space-y-6 sm:space-y-0 sm:py-1 justify-evenly items-center'>
      <h3 className='font-bold text-sm font-mono ml-2 mt-2 !text-red-50 sm:text-xs sm:w-full sm:m-0'>Stay updated with NewsLog!</h3>
      <h3 className='font-bold text-sm font-mono ml-2 mt-2 !text-red-50 sm:hidden'>Fearless, Independant, Reader-Funded!</h3>
        {authStatus ?
          (<Link to="/login">
            <LogoutBtn />
              </Link>) : 
