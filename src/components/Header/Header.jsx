                  ...
                  item.active && (
                    <li key={item.name}>
                      <button
                        ...
                        className={`inline-block px-3 py-1 sm:px-4 sm:py-2 duration-200 hover:bg-red-100 text-xs sm:text-sm rounded-full font-bold text-white hover:!text-red-50 hover:scale-110 tracking-[0.12px] text-center disabled:bg-red-500 ${item.category === request.category ? 'bg-red-500' : ''}`}
